...
def run():
    ...
    q6=float(tQuest.get())
    f = open(r"C:\Users\Yano\Desktop\MYFIRSTAPP\Pokedex.txt",'r')
    a = f.read().splitlines()
    q=open(r"C:\Users\Yano\Desktop\MYFIRSTAPP\h-tl.txt",'r')
    quest=q.read().splitlines()
    logfile = open(r'C:\Users\Yano\AppData\Roaming\ATLauncher\instances\Minecraft1122withForge\logs\latest.log','r')
...
window.iconbitmap(r"C:\Users\Yano\Desktop\MYFIRSTAPP\yano.ico")
